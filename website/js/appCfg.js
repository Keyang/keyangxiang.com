...
_app_ = {
	...
	appContainer : "#dypages", //the element in which the app will be rendered. it could be any jquery selector.
	...
	interfaces : {//User-defined implementation according to their descriptions. They are affected by UI library chosen.
		...
		goForwPage : function(pageID) {
			var jQueryObj = $("#dypages #" + pageID);
			var curPage = $(".currentPage");
			if(curPage.length > 0) {
				curPage.fadeOut('normal', function() {
					curPage.removeClass("currentPage");
					jQueryObj.fadeIn('normal', function() {
